...
function getPool() {
  ...
  pool = new Pool({
    ...
    // Hard-Limit pro Query: 15s. Verhindert dass ein versehentlich
    // langsamer Query (z.B. fehlender Index, riesige Pseudo-Migration)
    // den Express-Worker blockiert. Realistische Queries hier laufen
    // alle <50ms; 15s ist >100x Sicherheitsmarge.
    statement_timeout: 15 * 1000,
    // Verhindert dass eine Connection ewig "idle in transaction" haengt
    // wenn ein Caller vergessen hat COMMIT/ROLLBACK zu rufen.
